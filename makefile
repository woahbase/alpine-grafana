...
VERSION   ?= $(call get_gh_version,grafana/grafana)
...
OTHERFLAGS := \
	...
	-e PGID=$(PGID) \
	-e PUID=$(PUID) \
	# -e GRAFANA_HOME="/var/lib/grafana" \
	# -e GF_PATHS_CONFIG="/var/lib/grafana/conf/defaults.ini" \
	# -e GF_PATHS_DATA="/var/lib/grafana/data" \
	# -e GF_PATHS_HOME="/var/lib/grafana" \
...
SRC_ARCH_MAP := \
	...
	'armhf'  ) echo -n 'linux-armv6' ;; \
	'armv7l' ) echo -n 'linux-armv7' ;; \
	'i386'   ) echo -n 'N/A'         ;; \
	'loong64') echo -n 'N/A'         ;; \
	'ppc64le') echo -n 'N/A'         ;; \
	'riscv64') echo -n 'N/A'         ;; \
